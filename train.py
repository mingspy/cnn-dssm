...
tf.app.flags.DEFINE_integer('sentence_len', 600,"input sentence length")
tf.app.flags.DEFINE_integer('vocab_size', 437403,"vocab size")
tf.app.flags.DEFINE_integer('embedding_size', 256,"input embedding size")
...
if __name__ == '__main__':
    ...
    if not is_hdfs: set_gpu_devices('3')
    tf.app.run()
